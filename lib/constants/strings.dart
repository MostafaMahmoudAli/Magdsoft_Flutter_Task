...
const  textButtonName = "Resend Code";
const  otpTitle = "Verify Phone";
const  loginNameTextField ="Enter Your Full Name";
const  loginPhoneTextField ="Enter Your Phone Number";
const  helpButtonName ="Continue";
const  customHomeAppBarText = "Search";
